...
class ActiveStorage::Attachment < PG::TextDecoder::Record
...
class ActiveStorage::DirectUploadsController < ActionMailbox::BaseController
  def create; end
...
class ActiveStorage::DiskController < ActionMailbox::BaseController
